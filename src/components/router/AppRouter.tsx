...
import OnibusPage from '@app/pages/DashboardPages/OnibusPage';
import { OnibusTable } from '../tables/onibusTable/OnibusTable';
import ParadasPage from '@app/pages/ParadasPage';
import { ParadasTable } from '../tables/paradasTable/ParadasTable';
import CidadesPage from '@app/pages/CidadesPage';
import { CidadesTable } from '../tables/cidadesTable/CidadesTable';
import RecomendacoesPage from '@app/pages/RecomendacoesPage';
import { RecomendacoesTable } from '../tables/recomendacoesTable/RecomendacoesTable';
import UsuariosPage from '@app/pages/UsuariosPage';
import { UsuariosTable } from '../tables/usuariosTable/UsuariosTable';
...
const Onibus = withLoading(OnibusPage);
const Paradas = withLoading(ParadasPage);
const Cidades = withLoading(CidadesPage);
const Recomendacoes = withLoading(RecomendacoesPage);
const Usuarios = withLoading(UsuariosPage);
...
export const AppRouter: React.FC = () => {
  ...
  return (
    <BrowserRouter>
      <Routes>
        <Route path={LINHAS} element={protectedLayout}>
          <Route index element={<DataTables />} />
          <Route path="Onibus" element={<OnibusTable />} />
          <Route path="Paradas" element={<ParadasTable />} />
          <Route path="Cidades" element={<CidadesTable />} />
          <Route path="Recomendacoes" element={<RecomendacoesTable />} />
