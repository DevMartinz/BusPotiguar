...
import { getEditableTableData, getUsuariosTableData, BasicTableRow, Pagination } from 'api/table.api';
import { UsuariosCell } from './UsuariosCell';
...
export const UsuariosTable: React.FC = () => {
  ...
  const fetch = useCallback(
    (pagination: Pagination) => {
      ...
      getUsuariosTableData(pagination).then((res) => {
