...
import { getEditableTableData, getRecomendacoesTableData, BasicTableRow, Pagination } from 'api/table.api';
import { RecomendacoesCell } from './RecomendacoesCell';
...
export const RecomendacoesTable: React.FC = () => {
  ...
  const fetch = useCallback(
    (pagination: Pagination) => {
      ...
      getRecomendacoesTableData(pagination).then((res) => {
